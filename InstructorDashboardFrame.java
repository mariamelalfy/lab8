...
public class InstructorDashboardFrame extends javax.swing.JFrame {
    ...
    private void setupTables() {
        ...
        String[] courseColumns = {"Course ID", "Title", "Description", "Students"};
        ...
        tblMyCourses.getColumnModel().getColumn(0).setPreferredWidth(80);
        tblMyCourses.getColumnModel().getColumn(1).setPreferredWidth(200);
        tblMyCourses.getColumnModel().getColumn(2).setPreferredWidth(300);
        tblMyCourses.getColumnModel().getColumn(3).setPreferredWidth(80);
        ...
        tblLessons.getColumnModel().getColumn(0).setPreferredWidth(80);   // Lesson ID
        tblLessons.getColumnModel().getColumn(1).setPreferredWidth(200);  // Title
        tblLessons.getColumnModel().getColumn(2).setPreferredWidth(400);  // Content Preview
...
// 2. REPLACE loadMyCourses() method
    ...
    private void initComponents() {
        ...
        myCoursesPanelLayout.setHorizontalGroup(
            ...
            .addGroup(myCoursesPanelLayout.createSequentialGroup()
                .addGap(14, 14, 14)
                .addGroup(myCoursesPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(myCoursesPanelLayout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        .addComponent(jPanel4, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addComponent(tblMyCourses1, javax.swing.GroupLayout.PREFERRED_SIZE, 657, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        cmbQuizLesson.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        createQuizPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, createQuizPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cmbQuizCourse, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(59, 59, 59)
                .addComponent(lblSelectLesson, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cmbQuizLesson, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(104, 104, 104))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, createQuizPanelLayout.createSequentialGroup()
    ...
    private void btnEditCourseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditCourseActionPerformed
        ...
        String newTitle = JOptionPane.showInputDialog(this,
                ...
                selected.getCourseTitle());

        if (newTitle != null && !newTitle.trim().isEmpty()) {
            String newDesc = JOptionPane.showInputDialog(this,
                    "Enter new course description:",
                    selected.getCourseDescription());

            if (newDesc != null && !newDesc.trim().isEmpty()) {
                selected.setCourseTitle(newTitle.trim());
                selected.setCourseDescription(newDesc.trim());

                List<Course> courses = dbManager.loadCourses();
                for (int i = 0; i < courses.size(); i++) {
                    if (courses.get(i).getCourseID() == selected.getCourseID()) {
                        courses.set(i, selected);
                        break;
                    }
                }
    ...
    private void btnCreateCourseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateCourseActionPerformed
        ...
        try {
            ...
            // Generate course ID NOW (when creating)
            List<Course> courses = dbManager.loadCourses();
            int newCourseId = dbManager.generateCourseId(courses);

            // Display the generated ID
            txtCourseID.setText(String.valueOf(newCourseId));
            ...
            currentInstructor.createCourse(String.valueOf(newCourseId));
            ...
            JOptionPane.showMessageDialog(this,
                    ...
                    + "Generated Course ID: " + newCourseId + "\n"
                    + "Title: " + title + "\n"
                    + "Description: " + (description.length() > 50 ? description.substring(0, 50) + "..." : description) + "\n"
                    + "Instructor: " + currentInstructor.getUsername(),
                    "Success",
                    JOptionPane.INFORMATION_MESSAGE);

            // Clear form for next course
